...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        "service_95j0122",   // add later
        "template_6mw5uw2",  // add later
        {
          name: formData.name,
          email: formData.email,
          message: formData.message,
        },
        "CY5gYnqU9amANqDr5"    // add later
      );
  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/Phanikartheek",
      color: "hover:text-white",
    },
    {
      name: "LinkedIn",
      icon: <Linkedin className="w-5 h-5" />,
      url: "https://www.linkedin.com/in/phani-kartheek-b87722276/",
      color: "hover:text-blue-400",
    },
    {
      name: "Email",
      icon: <Mail className="w-5 h-5" />,
      url: "https://mail.google.com/mail/?view=cm&fs=1&to=phanikartheek754@gmail.com",
